"""Increments the pyharness version and pushes a new release to PyPI.

This script can only be called by pyharness core committers, and will result
in permission errors otherwise.

Adapted from https://github.com/unlimitedlabs/orchestra/blob/master/release.py.
"""
